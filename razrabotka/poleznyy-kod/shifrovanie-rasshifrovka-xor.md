...
1. Добавить в общие макеты (или макеты объекта) файл: [ХЛ_XOR](./shifrovanie-rasshifrovka-xor)

2. Создайте общий модуль и задайте ему название (например ХЛ_ЛБ_Шифрование_Расшифровка). Общий модуль должен иметь атрибуты: Сервер, Вызов сервера
