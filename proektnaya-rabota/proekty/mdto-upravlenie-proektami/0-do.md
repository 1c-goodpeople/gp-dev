...
Вывод на печать кривой.

Убрать крестики в структуре ДДС, оставить только в начале и конце. Пустые выводить просто пустыми.

В группировке не выводить пустые группировки 3.

В Расшифровку не выводить строчку «Статья 01», 01 и т.д.)

Расшифровка Первичка - Сортировка по порядку Групп ДДС, не выводить данные пустых подгрупп;
...
Расшифровка. подтвержденная первичкой: Часть Статей ДДС берём по оплате. Акты и Авансовые отчеты прям из документов (отборы по датам документов)
...
В детализацию Акты оказанных услуг подтягивать за тот период, за который сделаны **!Проводки! по этому документу.** Номер акта брать Номер входящего, а не документа в 1С

В детализацию в шапку выводть договор субсидии просто Номер и Дату (отдельными). И дальше название субсидии. Брать из названия договора субсидии (туда добавить реквизит)

В детализацию В подписи добавить Начальник управления финансов и Бухгалтер.

!!! ПРИ ВЫВОДЕ НА ПЕЧАТЬ ПО СТРАНИЦАМ РАЗБИВАТЬ ВСЕ ОТЧЕТЫ